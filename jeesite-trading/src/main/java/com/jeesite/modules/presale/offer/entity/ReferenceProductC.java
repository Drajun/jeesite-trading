...
public class ReferenceProductC extends DataEntity<ReferenceProductC> {
	
	private static final long serialVersionUID = 1L;
	private OfferC offerCId;		// 报价单ID 父类
	...
	public ReferenceProductC(OfferC offerCId){
		this.offerCId = offerCId;
	}
	
	public OfferC getOfferCId() {
		return offerCId;
	}

	public void setOfferCId(OfferC offerCId) {
		this.offerCId = offerCId;
	}
	...
	@Length(min=0, max=64, message="外箱尺寸长度不能超过 64 个字符")
	...
	@Length(min=0, max=64, message="单个包装方式长度不能超过 64 个字符")
