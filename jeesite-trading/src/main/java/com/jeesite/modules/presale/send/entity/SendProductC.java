...
@Table(name="reference_product_c", alias="a", columns={
		...
		@Column(name="reference_id", attrName="sendSpecimenCId.id", label="寄样单ID", isQuery=false),
		...
		@Column(name="single_package_type", attrName="singlePackageType", label="单个包装方式", isQuery=false),
...
public class SendProductC extends DataEntity<SendProductC> {
	
	private static final long serialVersionUID = 1L;
	private SendSpecimenC sendSpecimenCId;		// 寄样单ID 父类
	...
	public SendProductC(SendSpecimenC sendSpecimenCId){
		this.sendSpecimenCId = sendSpecimenCId;
	}
	
	public SendSpecimenC getSendSpecimenCId() {
		return sendSpecimenCId;
	}

	public void setSendSpecimenCId(SendSpecimenC sendSpecimenCId) {
		this.sendSpecimenCId = sendSpecimenCId;
	}
