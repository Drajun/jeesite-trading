...
@Table(name="reference_product_c", alias="a", columns={
		...
		@Column(name="reference_id", attrName="returnCId.id", label="退换单ID", isQuery=true),
...
public class ReturnProductC extends DataEntity<ReturnProductC> {
	
	private static final long serialVersionUID = 1L;
	private ReturnC returnCId;		// 退换单ID 父类
	...
	public ReturnProductC() {
		this(null);
	}


	public ReturnProductC(ReturnC returnCId){
		this.returnCId = returnCId;
	}
	
	public ReturnC getReturnCId() {
		return returnCId;
	}

	public void setReturnCId(ReturnC returnCId) {
		this.returnCId = returnCId;
	}
